...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","page","value",["macro",7]],["map","fieldName","title","value",["macro",8]]],
      "vtp_useHashAutoLink":false,
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","page","value","\/CLP\/Enroll"],["map","fieldName","title","value","Enrollment Virtual Page"]],
      "vtp_useHashAutoLink":false,
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","page","value","\/landing\/choose-topics"],["map","fieldName","title","value","Choose Topics"]],
      "vtp_useHashAutoLink":false,
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","page","value","\/landing\/search"],["map","fieldName","title","value","Search on Landing Page"]],
      "vtp_useHashAutoLink":false,
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","page","value","\/landing\/browse-menu-item"],["map","fieldName","title","value","Browse Menu Item"]],
      "vtp_useHashAutoLink":false,
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript type=\"text\/gtmscript\"\u003EUD.Config.brand.is_team\u0026\u0026function(a,c,e,f,d,b){a.hj=a.hj||function(){(a.hj.q=a.hj.q||[]).push(arguments)};a._hjSettings={hjid:256788,hjsv:5};d=c.getElementsByTagName(\"head\")[0];b=c.createElement(\"script\");b.async=1;b.src=e+a._hjSettings.hjid+f+a._hjSettings.hjsv;d.appendChild(b)}(window,document,\"\/\/static.hotjar.com\/c\/hotjar-\",\".js?sv\\x3d\");\u003C\/script\u003E\n\n",
  ...
  "rules":[
    [["if",0],["add",0,3]],
    [["if",1],["add",1,9,10,11,12]],
    [["if",2],["add",2]],
    [["if",2,3],["unless",4],["add",4]],
    [["if",2,5,6],["add",5]],
    [["if",2,6,7],["unless",8],["add",6]],
    [["if",0,9,10],["add",7]],
    [["if",1,11],["add",8]],
    [["if",1],["unless",12],["add",13]]]
},
"runtime":[]
...
var Kd=[C.B,C.J],Ld=function(a){var b=a[C.Pd];b&&D(40);var c=a[C.Qd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Pd&&f!==C.Qd)if(-1<Ga(Kd,f)){var h=f,k=a[f],l=d[e];vd().set(h,k,l,"IN","IN-DL",c)}else{}},Md=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
Z.g.f=["google"],function(){(function(a){Z.__f=a;Z.__f.h="f";Z.__f.i=!0;Z.__f.priorityOverride=0})(function(a){var b=Zm("gtm.referrer",1)||H.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?ie(ke(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):Ym(String(b)):String(b)})}();
Z.g.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=xl(c,"gtm.click");$m(d)}}(function(b){Z.__cl=b;Z.__cl.h="cl";Z.__cl.i=!0;Z.__cl.priorityOverride=0})(function(b){if(!en("cl")){var c=W("document");kd(c,"click",a,!0);fn("cl")}I(b.vtp_gtmOnSuccess)})}();
...
Z.g.ua=["google"],function(){function a(p){return Nd(p)}function b(p,r){var u=!1;if(Ed()&&!u&&!e[p]){var t=function(){var v=gi(),x="gtm"+Ue(),A=n(r),w={name:x};l(A,w,!0);v("create",p,w);v(function(){v.remove(x)})};Id(t,C.J);Id(t,C.B);e[p]=!0}}var c,d={},e={},f={name:!0,clientId:!0,sampleRate:!0,siteSpeedSampleRate:!0,alwaysSendReferrer:!0,allowAnchor:!0,
...
l=function(p,r,u){var t=0;if(p)for(var v in p)if(!k[v]&&p.hasOwnProperty(v)&&(u&&f[v]||!u&&void 0===f[v])){var x=h[v]?Qa(p[v]):p[v];"anonymizeIp"!=v||x||(x=void 0);r[v]=x;t++}return t},n=function(p){var r={};p.vtp_gaSettings&&m(On(p.vtp_gaSettings.vtp_fieldsToSet,"fieldName","value"),r);m(On(p.vtp_fieldsToSet,"fieldName","value"),r);Nd(C.J)||(r.storage="none");Nd(C.B)||(r.allowAdFeatures=!1,r.storeGac=!1);Pk()||(r.allowAdFeatures=!1);Ok()||(r.allowAdPersonalizationSignals=!1);p.vtp_transportUrl&&
(r._x_19=p.vtp_transportUrl);if(Qa(r.urlPassthrough)){r._useUp=!0;var u=!1;Ed()&&!u&&(r._cs=a)}return r},
q=function(p){function r(ea,V){void 0!==V&&F("set",ea,V)}var u={},t={},v={},x={};if(p.vtp_gaSettings){var A=p.vtp_gaSettings;m(On(A.vtp_contentGroup,"index","group"),t);m(On(A.vtp_dimension,"index","dimension"),v);m(On(A.vtp_metric,"index","metric"),x);var w=m(A);w.vtp_fieldsToSet=void 0;w.vtp_contentGroup=void 0;w.vtp_dimension=void 0;w.vtp_metric=void 0;p=m(p,w)}m(On(p.vtp_contentGroup,"index","group"),t);m(On(p.vtp_dimension,"index","dimension"),v);m(On(p.vtp_metric,"index","metric"),x);var y=
n(p),z=ii(p.vtp_functionName);if(Ca(z)){var B="",E="";p.vtp_setTrackerName&&"string"==typeof p.vtp_trackerName?""!==p.vtp_trackerName&&(E=p.vtp_trackerName,B=E+"."):(E="gtm"+Ue(),B=E+".");var F=function(ea){var V=[].slice.call(arguments,0);V[0]=B+V[0];z.apply(window,V)},J=function(ea,V){return void 0===V?V:ea(V)},M=function(ea,V){if(V)for(var nb in V)V.hasOwnProperty(nb)&&F("set",ea+nb,V[nb])},N=function(){},P={name:E};l(y,P,!0);var ka=p.vtp_trackingId||u.trackingId;z("create",ka,P);F("set","&gtm",vj(!0));var S=!1;
Ed()&&!S&&(F("set","&gcs",Od()),b(ka,p));y._x_19&&(null==dd&&delete y._x_19,y._x_20&&!d[E]&&(d[E]=!0,z(ni(E,String(y._x_20)))));p.vtp_enableRecaptcha&&F("require","recaptcha","recaptcha.js");(function(ea,V){void 0!==p[V]&&F("set",ea,p[V])})("nonInteraction","vtp_nonInteraction");M("contentGroup",t);M("dimension",v);M("metric",x);var K={};l(y,K,!1)&&F("set",K);var T;
p.vtp_enableLinkId&&F("require","linkid","linkid.js");F("set","hitCallback",function(){var ea=y&&y.hitCallback;Ca(ea)&&ea();p.vtp_gtmOnSuccess()});var U=function(ea,V){return void 0===p[ea]?u[V]:p[ea]};if("TRACK_EVENT"==p.vtp_trackType){p.vtp_enableEcommerce&&(F("require","ec","ec.js"),N());var la={hitType:"event",eventCategory:String(U("vtp_eventCategory","category")),eventAction:String(U("vtp_eventAction","action")),eventLabel:J(String,
U("vtp_eventLabel","label")),eventValue:J(Oa,U("vtp_eventValue","value"))};l(T,la,!1);F("send",la);}else if("TRACK_SOCIAL"==p.vtp_trackType){}else if("TRACK_TRANSACTION"==
...
(F("require","ec","ec.js"),N());if(p.vtp_doubleClick||"DISPLAY_FEATURES"==p.vtp_advertisingFeaturesType){var Ja="_dc_gtm_"+String(p.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");F("require","displayfeatures",void 0,{cookieName:Ja})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==p.vtp_advertisingFeaturesType){var Wa="_dc_gtm_"+String(p.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");F("require","adfeatures",{cookieName:Wa})}T?F("send","pageview",T):F("send","pageview");Qa(y.urlPassthrough)&&ki(B)}if(!c){var db=p.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js";p.vtp_useInternalVersion&&!p.vtp_useDebugVersion&&(db="internal/"+db);c=!0;var xb=fj(y._x_19,"/analytics.js"),Xa=ih("https:","http:","//www.google-analytics.com/"+db,y&&!!y.forceSSL);O("analytics.js"===db&&xb?xb:Xa,function(){var ea=
gi();ea&&ea.loaded||p.vtp_gtmOnFailure();},p.vtp_gtmOnFailure)}}else I(p.vtp_gtmOnFailure)};(function(p){Z.__ua=p;Z.__ua.h="ua";Z.__ua.i=!0;Z.__ua.priorityOverride=0})(function(p){Pd(function(){q(p)},
[C.J,C.B])})}();
...
Z.g.aev=["google"],function(){function a(u,t){var v=ef(u,"gtm");if(v)return v[t]}function b(u,t,v,x){x||(x="element");var A=u+"."+t,w;if(q.hasOwnProperty(A))w=q[A];else{var y=a(u,x);if(y&&(w=v(y),q[A]=w,p.push(A),35<p.length)){var z=p.shift();delete q[z]}}return w}function c(u,t,v){var x=a(u,r[t]);return void 0!==x?x:v}function d(u,t){if(!u)return!1;var v=e(Wm());Fa(t)||(t=String(t||"").replace(/\s+/g,"").split(","));for(var x=[v],A=0;A<t.length;A++){var w=t[A];if(w.hasOwnProperty("is_regex"))if(w.is_regex)try{w=
new RegExp(w.domain)}catch(z){continue}else w=w.domain;if(w instanceof RegExp){if(w.test(u))return!1}else{var y=w;if(0!=y.length){if(0<=e(u).indexOf(y))return!1;x.push(e(y))}}}return!Nn(u,x)}function e(u){n.test(u)||(u="http://"+u);return ie(ke(u),"HOST",!0)}function f(u,t,v){switch(u){case "SUBMIT_TEXT":return b(t,"FORM."+u,h,"formSubmitElement")||v;case "LENGTH":var x=b(t,"FORM."+u,k);return void 0===x?v:x;case "INTERACTED_FIELD_ID":return l(t,"id",v);case "INTERACTED_FIELD_NAME":return l(t,"name",
v);case "INTERACTED_FIELD_TYPE":return l(t,"type",v);case "INTERACTED_FIELD_POSITION":var A=a(t,"interactedFormFieldPosition");return void 0===A?v:A;case "INTERACT_SEQUENCE_NUMBER":var w=a(t,"interactSequenceNumber");return void 0===w?v:w;default:return v}}function h(u){switch(u.tagName.toLowerCase()){case "input":return md(u,"value");case "button":return nd(u);default:return null}}function k(u){if("form"===u.tagName.toLowerCase()&&u.elements){for(var t=0,v=0;v<u.elements.length;v++)Gm(u.elements[v])&&
...
0})(function(u){var t=u.vtp_gtmEventId,v=u.vtp_defaultValue,x=u.vtp_varType;switch(x){case "TAG_NAME":var A=a(t,"element");return A&&A.tagName||v;case "TEXT":return b(t,x,nd)||v;case "URL":var w;a:{var y=String(a(t,"elementUrl")||v||""),z=ke(y),B=String(u.vtp_component||"URL");switch(B){case "URL":w=y;break a;case "IS_OUTBOUND":w=d(y,u.vtp_affiliatedDomains);break a;default:w=ie(z,B,u.vtp_stripWww,u.vtp_defaultPages,u.vtp_queryKey)}}return w;case "ATTRIBUTE":var E;if(void 0===u.vtp_attribute)E=c(t,
x,v);else{var F=u.vtp_attribute,J=a(t,"element");E=J&&md(J,F)||v||""}return E;case "MD":var M=u.vtp_mdValue,N=b(t,"MD",Pm);return M&&N?Sm(N,M)||v:N||v;case "FORM":return f(String(u.vtp_component||"SUBMIT_TEXT"),t,v);default:var P=c(t,x,v);hn(P,"aev",u.vtp_gtmEventId);return P}})}();





Z.g.html=["customScripts"],function(){function a(d,e,f,h){return function(){try{if(0<e.length){var k=e.shift(),l=a(d,e,f,h);if("SCRIPT"==String(k.nodeName).toUpperCase()&&"text/gtmscript"==k.type){var n=H.createElement("script");n.async=!1;n.type="text/javascript";n.id=k.id;n.text=k.text||k.textContent||k.innerHTML||"";k.charset&&(n.charset=k.charset);var q=k.getAttribute("data-gtmsrc");q&&(n.src=q,fd(n,l));d.insertBefore(n,null);q||l()}else if(k.innerHTML&&0<=k.innerHTML.toLowerCase().indexOf("<script")){for(var p=
[];k.firstChild;)p.push(k.removeChild(k.firstChild));d.insertBefore(k,null);a(k,p,l,h)()}else d.insertBefore(k,null),l()}else f()}catch(r){I(h)}}}var c=function(d){if(H.body){var e=
d.vtp_gtmOnFailure,f=jn(d.vtp_html,d.vtp_gtmOnSuccess,e),h=f.Zg,k=f.onSuccess;if(d.vtp_useIframe){}else d.vtp_supportDocumentWrite?b(h,k,e):a(H.body,od(h),k,e)()}else Um(function(){c(d)},
